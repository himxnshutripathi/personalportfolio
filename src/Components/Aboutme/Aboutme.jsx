  ...
  return (
    <div className='aboutme' id='aboutme'>
        ...
        <div className="aboutme-text">
            ...
            <p>Hi, I'm Himanshu Tripathi a Frontend Developer, Programmer and Web designer. I've completed my bachelor's degree in Computer Science and Engineering from Lovely Professional University.</p>
